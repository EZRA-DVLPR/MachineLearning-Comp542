...
%
  ...
  \begin{thebibliography}{}
    ...
    \bibitem{SVMExplained2} \href{https://www.spiceworks.com/tech/big-data/articles/what-is-support-vector-machine/amp/}{Article explaining SVM}

    \bibitem{CNNGuide} \emph{A Review of Convolutional Neural Networks, its Variants and Applications} by Shruti and Rekha

    %citation 15
    \bibitem{ReLu} \href{https://www.kaggle.com/code/dansbecker/rectified-linear-units-relu-in-deep-learning}{ReLu Explained}
    
    \bibitem{Dropout} \href{https://keras.io/api/layers/regularization_layers/dropout/#:~:text=The%20Dropout%20layer%20randomly%20sets,over%20all%20inputs%20is%20unchanged}{Dropout explained from Keras}
